          ...
          <div className="checkout-content">
                    ...
                    <div className="form__col">
                      <div className="select-wrapper select-form">
                        <select>
                          ...
                          <option value="Argentina">Argentina</option>  <option value="France">France</option>  <option value="England">England</option>
            ...
            <div className="checkout__col-4">
              <div className="block">
                ...
                <PayPalScriptProvider options={{"client-id": "AaxWIwvO_R5DFtgTRDeo6lK-UM3kQiwI2ALbtxLdtlvHBKk6yF6JF_pgZvKVjXyC2PjmNLHwPnyf0lXY"}}>
